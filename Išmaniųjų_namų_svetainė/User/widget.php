...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="widget.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Meteo</a>
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
            <div class="container">
                  <iframe class="iframe" src="https://www.meteoblue.com/en/weather/widget/three?geoloc=detect&nocurrent=0&noforecast=0&days=7&tempunit=CELSIUS&windunit=METER_PER_SECOND&layout=dark" ></iframe>
            </div>
        </div>
        <!-- Content End -->
