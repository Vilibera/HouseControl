...
(function() {
    ...
    function _getExtents(data, key) {
        var nData = _.chain(data).pluck("data").flatten().value();
        return {
    ...
    (function() {
        ...
        function enter(self, storage, className, data, callbacks) {
            var inter = self._options.interpolation,
                ...
                line = d3.svg.line().x(x).interpolate(inter),
                area = d3.svg.area().x(x).y1(self.yZero).interpolate(inter),
                container, fills, paths;
